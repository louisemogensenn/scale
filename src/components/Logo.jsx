...
export default function Logo() {
    ...
    return (
        ...
        <>
            <Link to="/">
                <svg className={mystyle.topLogo} xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 338.96 91.6" fill="#000000"> {/* Generator: Adobe Illustrator 28.7.5, SVG Export Plug-In . SVG Version: 1.2.0 Build 176) */}
                        <g>
                            <g id="Layer_1">
                                <g>
                                    <g>
